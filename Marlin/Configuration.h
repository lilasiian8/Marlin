...
#define STRING_CONFIG_H_AUTHOR "(lilasiian8-Ender 3 Pro BLTouch E3D V6 Neopixel BMG MDD)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "lilasiian8-v8 MDD v1.2"
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -47, -1, -1.75 }
